...
class QRspec
{
    ...
    public static function debug($frame, $binary_mode = false)
    {
        if ($binary_mode) {
            ...
            echo '<style>.p { background-color: yellow; }.m { background-color: #00FF00; }.s { background-color: #FF0000; }.c { background-color: aqua; }.x { background-color: pink; }.f { background-color: gold; }</style>';
            echo "<pre><tt>";
            echo join("<br/ >", $frame);
            echo "</tt></pre>";
